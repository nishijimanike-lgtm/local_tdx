...
/// 默认的超时值。
///
/// Upstream rustdx uses 100ms, which is too aggressive for many networks:
/// TDX handshake (3 setup packets) commonly needs 1–4s end-to-end.
/// Patched for local_tdx: 5s connect/read/write timeout.
